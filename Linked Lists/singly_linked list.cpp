...
class Node // A node class to represent a node of the linked list.
{
public:
    int data;
    Node *next;
...
public:
    ...
    void insertNode(int); // Function to insert a node at the end of the linked list.
    void printList();     // Function to print the linked list.
    void deleteNode(int); // Function to delete the node at a given position
};
